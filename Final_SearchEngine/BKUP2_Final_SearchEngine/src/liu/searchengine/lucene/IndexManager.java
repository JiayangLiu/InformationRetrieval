...
public class IndexManager {
	...
	//对JavaBean索引
	public synchronized void createIndex(List<Joke> joke_list){
		...
		for (int i=0; i<joke_list.size(); i++){
			// System.out.println("joke_list不为空");
			n = joke_list.get(i);
			idField=new Field("id", n.getId()+"", Store.YES, Index.NOT_ANALYZED_NO_NORMS);
			idField.setBoost(0.0001F);
			// System.out.println(n.getContent());
			// System.out.println("IndexManager: " + n.getContent());
			// System.out.println("IndexManager: " + i + n.getContent());
			String atr = null;
			atr = n.getContent();
