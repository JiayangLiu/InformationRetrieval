...
void LRCtoTXT::getLyricHeader(QString str)
{
    switch (i1) {
    case 0:
        Lheader[0] = QString::fromStdString(str.toStdString().substr(4, str.length()-6));
        break;
    case 1:
        Lheader[1] = QString::fromStdString(str.toStdString().substr(4, str.length()-6));
        break;
    case 2:
        Lheader[2] = QString::fromStdString(str.toStdString().substr(4, str.length()-6));
        break;
    defalut:
        break;
    }
